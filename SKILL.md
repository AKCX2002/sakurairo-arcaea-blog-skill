...
11. **--theme-skin 未覆盖**：若主题自定义 CSS 中 `--theme-skin` 尚未设置为深色值（如 `#0a0e18`），某些元素可能仍为浅色。在主题选项的自定义 CSS 中添加 `:root { --theme-skin: #0a0e18; }` 覆盖。
